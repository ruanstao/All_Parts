...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        // Initialization code
        self.scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 22, 320, 80*2)];
        ...
        self.pageControl = [[UIPageControl alloc] initWithFrame:CGRectMake(320/2, 85*2 + 22, 0, 20)];
...
-(id)init
{
    ...
    if (self) {
        ...
        self.iconView = [[UIImageView alloc] initWithFrame:CGRectMake(6.5, 0, 55, 55)];
        ...
        self.titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(-2.5, 56, 70, 13)];
